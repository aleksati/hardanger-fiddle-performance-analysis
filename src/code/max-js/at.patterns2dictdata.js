...
var num_bars = global_beat_ratios.length;
    ...
    if (patterns.length) {
        ...
        if (found_pattern.length) { 
            ...
            for (var x=0; x<found_pattern.length; x+=2) {
                ...
                if ((found_pattern[x+1]+1) <= num_bars) {
            ...
            post("No more matches were found..");
        ...
        error("(patterns2dictdata) -- Pattern array is empty. Add transcription or pattern.text first.");
    }
}